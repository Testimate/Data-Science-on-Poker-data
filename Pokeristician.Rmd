...
#### My performance on Monday:
```{r echo=FALSE, warning=FALSE}
Testimate %>% 
  select(Day, Stake, sesStart, sesEnd, sesLength, Profit, profitPerHr) %>% 
    filter(Day == "Mon") %>%
      arrange(desc(Profit)) # %>% View()
```
...
#### B.1 Session Profit (Enlightened Era)
